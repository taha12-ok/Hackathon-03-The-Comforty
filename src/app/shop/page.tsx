...
const products = [
  ...
  { id: 10, image: "/p1.png", name: "Library Stool Chair", price: "$20", Link1: "/product1", Link2: "/product" },
  { id: 11, image: "/p2.png", name: "Rose Luxe Armchair", price: "$20", Link1: "/product2", Link2: "/product" },
  { id: 12, image: "/p3.png", name: "Citrus Edge", price: "$20", Link1: "/product3", Link2: "/product" },
  { id: 13, image: "/p4.png", name: "Ivory Charm", price: "$20", Link1: "/product4", Link2: "/product" },
  { id: 14, image: "/p6.png", name: "Nordic Spin", price: "$20", Link1: "/product5", Link2: "/product" },
  { id: 15, image: "/p5.png", name: "Gray Elegance", price: "$8", Link1: "/product6", Link2: "/product" },
  { id: 16, image: "/p7.png", name: "Modern Cozy", price: "$20", Link1: "/product7", Link2: "/product" },
  { id: 17, image: "/p8.png", name: "Scandi Dip Set", price: "$40", Link1: "/product8", Link2: "/product" },
  { id: 18, image: "/p9.png", name: "SleekSpin", price: "$20", Link1: "/product9", Link2: "/product" },
]
        ...
        <div className="mb-6">
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00B4B4]"
            />
